...
import com.snakes.services.FileUploadService;
...
//	public static String uploadDirectory = System.getProperty("snake.dir") + "/uploads";
	...
	public String addNewSnake(@Valid @ModelAttribute("snake") Snake newSnake, BindingResult result, HttpSession session,
	...
	public String viewSnake(@PathVariable("id") Long id, HttpSession session, Model model,
			@ModelAttribute("snake") Snake snake) {
		if (session.getAttribute("userId") == null) {
			return "redirect:/logout";
		}
	...
	public String updateSnake(@PathVariable("id") Long id, @Valid @ModelAttribute("snake") Snake snake,
			BindingResult result, HttpSession session, @RequestParam("image") MultipartFile multipartFile)
			throws IOException {
