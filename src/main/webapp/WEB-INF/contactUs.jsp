...
<body class="text-center">
	...
	<div class="content container">
		...
		<p>We are located in Sunny St Petersburg FL, and will happily
			supply an address for pickup via email.</p>
		<p>
			<span class="fw-bold">Phone:</span> 1-727-not-done
		</p>
		<p>
			<span class="fw-bold">Email:</span> ToothyNoodle@gilboa.com
		</p>
	...
	<div class="container mx-auto col-5">
		<form:form action="/contact/email" method="post"
			class="m-2 form opacity-75 form-control p-4"
