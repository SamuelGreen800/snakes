...
<body class="">
			...
			<div class="container-fluid mx-4">
				...
				<div class="collapse navbar-collapse pb-5 text-dark" id="navbarText">
					<ul class="navbar-nav text-dark ms-auto mb-4 mb-lg-0">
						...
						<li class="nav-item px-5 pb-5" id="darkLink"><a
							class="nav-link" href="/care">Care</a></li>
						<li class="nav-item px-5" id="darkLink"><a class="nav-link"
							href="/sales">Sales</a></li>
						<li class="nav-item px-5"><a class="nav-link" id="darkLink"
	...
	<div class="content justify-content-start ">
		<div class="">
			...
			<div
				class=" col-6 my-1 mx-5 justify-content-start border border-success p-2 bg-light">
				<h5>All Snakes:</h5>
				<table class="table table-striped table-light  shadow-lg p-3 my-3">
					...
					<c:forEach var="eachSnake" items="${snakes}">
						...
						<tr>
							<td><a href="/admin/view/${eachSnake.id}" class="text-dark"><c:out
										value="${eachSnake.name}" /></a></td>
				...
				<div class=" d-flex justify-content-between">
					<a href="/admin/new" class="btn text-center btn-primary">Add a
						snake</a> <a href="/sales" class="btn text-center btn-info">Sales
						page</a> <a href="/logout"
						class="btn text-center fw-boldtext-dark btn-danger">Logout</a>
				</div>
			</div>
