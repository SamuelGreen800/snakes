	...
	<section id="sectionEdit">
		<div class="px-5 pb-3">
			...
			<div class="container py-4 col-7">
				...
				<form:form action="/admin/${snake.id}" method="post"
					class="form opacity-75 form-control p-4"
					enctype="multipart/form-data" modelAttribute="snake">
					<h1 class="py-4 text-center text-success">Edit snake</h1>

					<div
						class="form-group  fw-bold d-flex justify-content-between my-5">
					...
					<div class="form-group d-flex fw-bold justify-content-between mt-5">
						...
						<form:textarea rows="4" class="input col-7" path="description"
							value="${snake.description }" />
					</div>

					<div class="">

						<form:input type="hidden" class="col-7" value="${snake.photos }"
							path="photos" />
					</div>


					<input type="file" class="my-4" name="image"
						value="${snake.photos}"></input>

					<div class="form-group d-flex fw-bold justify-content-between">
						<input class="btn btn-success mt-4 mb-2" type="submit"
							value="Update" />
						<h2 class="text-center">
							<a href="/admin" class="btn mt-4 btn-primary">Dashboard</a>
						</h2>
						<h2 class="text-center">
							<a href="/admin/delete/${snake.id }" class="btn mt-4 btn-danger">Delete</a>
						</h2>
					</div>
