...
<body class="text-center">
	...
	<div class="content container">
		...
		<img class="my-3" src="/img/terrarium.jpg" style="width: 50rem;" name="terr" alt="Terrarium picture">
		<div><label class="mb-5" for="terr">A pimped out snake house</label></div>
		<p>Sometimes they sing:"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum." </p>
		<p>They also eat warm things.</p>
		
				<img class="my-3" src="/img/british-harvest-mouse-1.jpg" style="width: 50rem;" name="mouse" alt="Terrarium picture">
		<div><label class="mb-5" for="mouse">A Snak</label></div>
