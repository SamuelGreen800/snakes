...
<body class="text-center">
	...
	<div class="content container">
		<h1>This is the care page</h1>
		<p>Here, you can find cool stuff about keeping these dudes alive.</p>

		<p>They like quite warm things, like heat lamps.</p>

		<img class="my-3" src="/img/terrarium.jpg" style="width: 50rem;"
			name="terr" alt="Terrarium picture">
		<div>
			<label class="mb-5" for="terr">A pimped out snake house</label>
		</div>
		<p>Sometimes they sing:"Lorem ipsum dolor sit amet, consectetur
			...
			laborum."</p>
		<p>They also eat warm things.</p>

		<img class="my-3" src="/img/british-harvest-mouse-1.jpg"
			style="width: 50rem;" name="mouse" alt="Terrarium picture">
		<div>
			<label class="mb-5" for="mouse">A Snak</label>
		</div>


		<p>And more to come soon!</p>
