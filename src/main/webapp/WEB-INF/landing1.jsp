...
<body class="text-center">
	...
	<div class="content container">
		<h1>Welcome to Gilboa.com!</h1>
		<h4>We here at Gilboa.com aren't really accredited by anyone or
			anything. No gods, no masters.</h4>
		<h5>But we bet we've been bitten by more snakes than you.</h5>

		<p>Browse on to find stuff.</p>
	</div>
